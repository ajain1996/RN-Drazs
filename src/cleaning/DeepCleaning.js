...
export default function DeepCleaning({ navigation }) {
    return (
        <ScrollView>
            <View>
                <Image
                ...
                <View style={{ paddingHorizontal: 16, paddingVertical: 12 }}>
                    <Text style={{ ...commonStyles.fs20_700, marginBottom: 10 }}>Deep Cleaning</Text>
                    ...
                    <CustomButton
                        ...
                        width={"100%"} height={50}
                        onPress={() => { navigation.navigate("FurnitureMovingCleaning") }}
                    />
                </View>
            </View>
        </ScrollView>
